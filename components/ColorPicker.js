...
const srcWheel = require('../assets/images/color-wheel.png')
const srcSlider = require('../assets/images/black-gradient.png')
const srcSliderRotated = require('../assets/images/black-gradient-rotated.png')
